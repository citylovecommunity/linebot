...
from shared.database.models import Member, MemberMatchScore, WeeklyMatch, Session
from shared.scoring import calculate_match_score, UserProfileAdapter
...
def run_weekly_matching():
    ...
    active_users = session.query(Member).all()

    for me in active_users:
        print(f"Processing matches for {me.line_id}...")
